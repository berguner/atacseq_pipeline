...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        ...
        for f in self.find_log_files(sp_key='bsf_fastqc/data'):
        ...
        for f in self.find_log_files(sp_key='bsf_fastqc/zip', filecontents=False):
            s_name = f['fn']
    ...
    def gc_content_plot (self):
        ...
        for f in self.find_log_files('bsf_fastqc/theoretical_gc'):
